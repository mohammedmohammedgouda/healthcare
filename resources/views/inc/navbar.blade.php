...
<a href="/" class="text-4xl font-bold"><span class="text-primary">Health </span>Care</a>

<div class="flex items-center">
     @if (Auth::check())
                <a href="#" class="bg-base-300/25 hover:bg-base-300/50 p-3 ease-in-out duration-300 rounded-full flex items-center text-lg">
                    @if (Auth::user()->avatar)
        ...
        <a href="/dashboard" target="_blank" class="btn btn-outline mx-2 btn-md md:btn-lg">Dashboard</a>
